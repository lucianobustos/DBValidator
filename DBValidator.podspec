#
#  Be sure to run `pod spec lint DBValidator.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lucianobustos/DBValidator"
  ...
  s.source       = { :git => "https://github.com/lucianobustos/DBValidator.git", :tag => "0.0.2" }
